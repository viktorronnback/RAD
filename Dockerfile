...
RUN git clone https://github.com/ultralytics/ultralytics -b main /app/ultralytics
ADD https://github.com/ultralytics/assets/releases/download/v8.1.0/yolov8n.pt /app/ultralytics/

COPY . /app

# Install pip packages
RUN python3 -m pip install --upgrade pip wheel
RUN pip install --no-cache -e "./ultralytics/[export]" albumentations comet pycocotools
